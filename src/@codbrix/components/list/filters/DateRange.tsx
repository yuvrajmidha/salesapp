...
import { BsArrowReturnRight } from 'react-icons/bs'
  ...
  // 2. Create the form
  export const DateRange = ({ firstFieldRef, onCancel }:any) => {
    return (
      <Stack spacing={4} py={2}>
          ...
          <Box>
            <Select size="sm" rounded={"md"}>
                ...
                <option value="between">is after</option>
                <option value="between">is on or after</option>
                <option value="between">is before</option>
                <option value="between">is on or before</option>
            </Select>
            <HStack mt={1} mx="-0.25rem" spacing={0}>
                ...
                <Box px={1} w="100%">
                  <Input type="date" defaultValue={""} size="sm" rounded={"md"} />
                </Box>
            </HStack>
            <HStack mt={1} mx="-0.25rem" spacing={0}>
                <Center fontSize={"13px"} px={1} color={mode("primary.500", "white")}>
                    and
                </Center>
                <Box px={1} w="100%">
                  <Input type="date" defaultValue={""} size="sm" rounded={"md"} />
